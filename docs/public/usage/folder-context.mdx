...
When you work with Claude Code in a project, Engram tracks which files are read and modified. After each observation is saved, it automatically:
...
1. When generating context, Engram detects if your project is a worktree
