...
description: "Learn how Engram works automatically in the background"
---
...
Engram works automatically once installed. No manual intervention required!
...
Every time Claude uses a tool, Engram captures it:
...
Context is stored in SQLite database at `~/.engram/claude-mem.db`.
...
Engram supports sessions that span multiple user prompts:
...
Engram provides MCP tools for querying your project history. Simply ask naturally:
