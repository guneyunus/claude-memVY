...
<Tip>
**Recommended**: Enable billing on your Google Cloud project to unlock much higher rate limits. You won't be charged unless you exceed the generous free quota. This allows Engram to process observations instantly instead of waiting between requests.
</Tip>
