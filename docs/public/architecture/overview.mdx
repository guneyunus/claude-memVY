...
description: "System components and data flow in Engram"
---
...
Engram operates as a Claude Code plugin with the following core components:
...
│    "run: npx @guneyunus/engram repair" to stderr. Always exits 0.      │
└─────────────────────────────────────────────────────────────────┘
                              ↓
┌─────────────────────────────────────────────────────────────────┐
...
The actual runtime install (Bun, uv, `bun install`) is performed by `npx @guneyunus/engram install` / `npx @guneyunus/engram repair` with a visible installer spinner; the Setup hook itself only reads the `.install-version` marker.
