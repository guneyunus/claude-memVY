...
**Location:** `/Users/YOUR_USERNAME/.claude/plugins/marketplaces/engram/plugin/scripts/mcp-server.cjs`
...
The 3-layer workflow embodies **progressive disclosure** - a core principle of Engram's architecture.
...
2. Check database: `ls ~/.engram/claude-mem.db`
